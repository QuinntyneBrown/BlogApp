...
const template = require("./app-item-embed.component.html");
const styles = require("./app-item-embed.component.scss");

export class AppItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new AppDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new AppEdit(this.entity));
    }
...
customElements.define(`ce-app-item-embed`,AppItemEmbedComponent);
