...
const template = require("./metric-item-embed.component.html");
const styles = require("./metric-item-embed.component.scss");

export class MetricItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new MetricDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new MetricEdit(this.entity));
    }
    ...
    public entity: Metric;
}

customElements.define(`ce-metric-item-embed`,MetricItemEmbedComponent);
