...
using static MetricsDrivenDevelopment.UnityConfiguration;

namespace MetricsDrivenDevelopment
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "MetricsDrivenDevelopment"))
                .EnableSwaggerUi();
