...
namespace MetricsDrivenDevelopment.Data
{
    public interface IMetricsDrivenDevelopmentContext
    {
    ...
    public class MetricsDrivenDevelopmentContext: DbContext, IMetricsDrivenDevelopmentContext
    {
        public MetricsDrivenDevelopmentContext()
            :base("MetricsDrivenDevelopmentContext")
        {
